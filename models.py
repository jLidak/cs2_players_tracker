...
class Team(Base):
    ...
    matches_as_team1: Mapped[List["Match"]] = relationship(
        "Match", foreign_keys="Match.team1_id", back_populates="team1", cascade="all, delete-orphan"
    )
    matches_as_team2: Mapped[List["Match"]] = relationship(
        "Match", foreign_keys="Match.team2_id", back_populates="team2", cascade="all, delete-orphan"
    )
...
class Player(Base):
    ...
    tournament_performances: Mapped[List["PlayerTournamentPerformance"]] = relationship(
        "PlayerTournamentPerformance", back_populates="player", cascade="all, delete-orphan"
    )
...
class Tournament(Base):
    ...
    player_performances: Mapped[List["PlayerTournamentPerformance"]] = relationship(
        "PlayerTournamentPerformance", back_populates="tournament", cascade="all, delete-orphan"
    )
